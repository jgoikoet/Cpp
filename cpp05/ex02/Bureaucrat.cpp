...
/*   Updated: 2024/02/23 15:57:36 by jgoikoet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (!form.getSigned())
		std::cout << _name << " couldn`t execute " << form.getName() << " because is not signed" << std::endl;
	else if(this->_grade > form.getExecuteGrade())
		std::cout << _name << " couldn`t execute " << form.getName() << " because his grade isn`t high enough" <<std::endl;
	else

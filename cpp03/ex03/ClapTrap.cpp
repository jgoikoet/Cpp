...
/*   Updated: 2024/01/16 19:10:18 by jgoikoet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	std::cout  << _name << "`s ClapTrap Default constructor called" << std::endl;
}

ClapTrap::ClapTrap	(std::string name) :  _name(name), _hitPoints(10), _energyPoints(10), _attackDamage(0)
{
	std::cout << _name << "`s ClapTrap Name constructor called" << std::endl;
}

ClapTrap::ClapTrap	(ClapTrap const & src)
{
	*this = src;
	std::cout << "Claptrap Copy constructor called " << this->_name << " has been created" << std::endl;
}
...
void		ClapTrap::beRepaired(unsigned int amount)
{
	if (this->_energyPoints)
	{
		std::cout << _name << " repares it self adding " << amount  << " points to it`s hip points" << std::endl;
		this->_hitPoints += amount;
		_energyPoints--;
	}
}
...
void	ClapTrap::setEnergyP(int n)
{
	this->_energyPoints = n;
}

void	ClapTrap::setAttackD(int n)
{
